...
################################################################################
## Form generated from reading UI file 'costomFileCopy.ui'
##
...
class Ui_MainWindow__filecopy(object):
    def setupUi(self, MainWindow__filecopy):
        ...
        MainWindow__filecopy.resize(609, 379)
        self.centralwidget = QWidget(MainWindow__filecopy)
        self.centralwidget.setObjectName(u"centralwidget")
        self.splitter = QSplitter(self.centralwidget)
        self.splitter.setObjectName(u"splitter")
        self.splitter.setGeometry(QRect(1, 31, 588, 289))
        ...
        self.menubar.setGeometry(QRect(0, 0, 609, 20))
