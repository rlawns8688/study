...
from timer.resources.rc import icons_rc
from timer.resources.rc import images_rc
...
class Ui_Form__timer(object):
    def setupUi(self, Form__timer):
        ...
        self.label_3 = QLabel(Form__timer)
        self.label_3.setObjectName(u"label_3")

        self.horizontalLayout_5.addWidget(self.label_3)

        self.comboBox__dependency = QComboBox(Form__timer)
        self.comboBox__dependency.setObjectName(u"comboBox__dependency")

        self.horizontalLayout_5.addWidget(self.comboBox__dependency)
    ...
    def retranslateUi(self, Form__timer):
        ...
        self.label_3.setText(QCoreApplication.translate("Form__timer", u"Dependency", None))
